	...
	<?php for ($i = 0; $i < $count; $i++): ?>
      ...
      echo '<div class="row">';
			...
			<div class="item col-xs-12 col-sm-6 col-lg-<?php echo 12 / $column; ?>">
				<div class="round">
					<div class="round">
						<a href="<?php echo $helper->get('profile_link', $i ); ?>"><img class="round" src="<?php echo $helper->get('data.img', $i ); ?>" alt="" /></a>
					</div>
					<a href="<?php echo $helper->get('profile_link', $i ); ?>"><div class="staff-inner">
						<div class="member-title">
							<?php if ($helper->get('name-member', $i)): ?>
								<h4><?php echo $helper->get('name-member', $i); ?></h4>
							<?php endif; ?>
