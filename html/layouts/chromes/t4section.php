...
if($params->get('sub-heading')) {
	$moduleSub = '<span class="sub-heading font-heading-family text-'.$subColor.'">'.$params->get('sub-heading').'</span>';
}
...
if (!empty ($module->content)) {
	...
	if ($module->showtitle != 0 || $params->get('sub-heading')) {
		$html .= "<div class=\"container\"><div class=\"section-title-wrap text-{$moduleAli}\">{$modTitle}{$moduleSub}</div></div>";
	}
