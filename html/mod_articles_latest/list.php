	...
	<div class="container">
		<div class="row equal-height equal-height-child">
			<?php if ($grouped): ?>
				...
				<li>
					<div class="mod-articles-category-group"><?php echo JText::_(
         $group_name
     ); ?></div>
					<ul>
							...
							<li>
								...
								<?php if ($params->get('show_tags', 0) && $item->tags->itemTags): ?>
									<div class="mod-articles-category-tags">
										<?php echo HTMLHelper::render('joomla.content.tags', $item->tags->itemTags); ?>
									</div>
								<?php endif; ?>
			...
			<?php else: ?>
				<?php foreach ($list as $item): ?>
					<?php
     $customs = JLayoutHelper::getCustomFields2($item, 'article');
							...
							<div class="info-top">
								<div class="intro-image">
									<?php if ($images->image_intro): ?>
										<?php echo HTMLHelper::render('joomla.content.intro_image', $item); ?>
									<?php else: ?>
										<span>No Image</span>
									<?php endif; ?>

									<?php if (!empty($customs['rent-or-sale'])): ?>
										<span class="tag-label label-<?php echo $customs['rent-or-sale']
              ->value; ?>"><?php echo Jtext::_('TPL_FOR') .
    ' ' .
    $customs['rent-or-sale']->value; ?></span>
									<?php endif; ?>

									<span class="featured-label featured-label-<?php if ($item->featured):
             echo 'yes';
         else:
             echo 'no';
         endif; ?>">
                 ...
                 $params->get('readmore_limit')
							...
							<div class="ct-field-footer">
								<?php if (
            !empty($customs['area']) ||
            !empty($customs['bathrooms']) ||
            !empty($customs['bedrooms'])
        ): ?>
								...
								<div class="ct-field-row">
									...
									<?php if ($params->get('show_author')): ?>
										<div class="ct-field mod-articles-category-writtenby">
											<?php echo HTMLHelper::render('joomla.content.info_block.author_property', [
               'item' => $item,
               'params' => $item->params,
           ]); ?> 
										</div>
