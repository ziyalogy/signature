...
if (empty($this->columns)) $this->columns = 3;

?>
<div class="com-content-category-blog container blog <?php echo $this->pageclass_sfx;?>" itemscope itemtype="https://schema.org/Blog">
	...
	<?php foreach ($this->intro_items as $key => &$item) : ?>
		...
		<?php endif; ?>
			<div class="col col-md-<?php echo 12/$this->columns;?> col-sm-12 col-xs-12">
