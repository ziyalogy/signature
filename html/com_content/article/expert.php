...
<div class="com-content-article item-page<?php echo $this->pageclass_sfx; ?>">
	...
	<div class="page-header">
		<h3> Meet <?php echo $this->escape($this->params->get('page_heading')); ?> </h3>
	</div>
	<?php endif; ?>
	...
	<div class="page-header">
		<?php if ($params->get('show_title')): ?>
			<h3 itemprop="headline">
				Meet <?php echo $this->escape($this->item->title); ?>
			</h3>
		<?php endif; ?>
...
?>
	...
	<?php // Optional link to let them register to see the whole article.
     ...
     ?>
		...
		<?php $link = new Uri(
      Route::_('index.php?option=com_users&view=login&Itemid=' . $itemId, false)
  ); ?>
		<?php $link->setVar(
      'return',
      base64_encode(
...
<script type="application/ld+json">
{
	...
	"articleBody": <?php echo json_encode(
     preg_replace('/\s+/', ' ', strip_tags($this->item->text))
 ); ?>,
	"image": 
	{
		"@type": "imageObject",
